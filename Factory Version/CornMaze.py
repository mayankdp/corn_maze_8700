...
pygame.init()
background = pygame.image.load('/Users/mattiagalanti/Desktop/CornMazeNew/Images/background.png')
pygame.display.set_caption("Corn Maze")
icon = pygame.image.load('/Users/mattiagalanti/Desktop/CornMazeNew/Images/icongame.ico')
...
class Button():
	...
	def changeColor(self, position):
		if position[0] in range(self.rect.left, self.rect.right) and position[1] in range(self.rect.top, self.rect.bottom):
			self.text = main_font.render(self.text_input, True, (0, 0, 255))
		else:
			self.text = main_font.render(self.text_input, True, (255, 0, 0))
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if output == True:
                    ...
                    for wall in walls:
                        ...
                        playerImg = pygame.image.load("/Users/mattiagalanti/Desktop/CornMazeNew/Images/marathon.png")
                        playerImg = pygame.transform.scale(playerImg, (38, 38))
                        screen.blit(playerImg, pygame.Rect(32, 32, 20, 20))
                        pygame.draw.rect(screen, (255, 0, 0), end_rect)
                        mixer.init()
                        mixer.music.load(r"/Users/mattiagalanti/Desktop/CornMazeNew/Music/background.wav")
...
button_surface = pygame.image.load("/Users/mattiagalanti/Desktop/CornMazeNew/Images/button.png")
